...
class COCOKeypointDataset(Dataset):
    ...
    def __init__(self, root_dir, split='train', img_size=256, heatmap_size=64, max_samples=None):
        """
        Args:
        ...
        if split == 'train':
            ...
            self.ann_file = os.path.join(root_dir, 'annotations', 'person_keypoints_train2017.json')
        else:
            self.img_dir = os.path.join(root_dir, 'val2017')
            self.ann_file = os.path.join(root_dir, 'annotations', 'person_keypoints_val2017.json')
